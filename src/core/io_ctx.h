...
[[nodiscard]] int io_ctx_param_i64(const io_ctx_t *c, const char *name,
                                   int64_t *out);
[[nodiscard]] int io_ctx_param_u64(const io_ctx_t *c, const char *name,
                                   uint64_t *out);
...
[[nodiscard]] int io_ctx_set_header(io_ctx_t *c, const char *name,
                                    const char *value);
...
[[nodiscard]] int io_ctx_redirect(io_ctx_t *c, uint16_t status,
                                  const char *url);
[[nodiscard]] int io_ctx_error(io_ctx_t *c, uint16_t status,
                               const char *message);
