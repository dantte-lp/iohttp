...
int io_response_set_header(io_response_t *resp, const char *name,
                           const char *value)
{
...
int io_respond(io_response_t *resp, uint16_t status, const char *content_type,
...
int io_respond_json(io_response_t *resp, uint16_t status, const char *json)
{
    ...
    return io_respond(resp, status, "application/json",
